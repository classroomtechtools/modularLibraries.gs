/**
  ...
  * Based on LoDash 4.17.11 <<https://lodash.com>
  * Copyright Adam Morris, ClassroomTechTools https://classroomtechtools.com
*/
...
function Package_ (config) {
  ...
  return (function() {
    ...
    var root = {};  // freeGlobal || freeSelf || Function('return this').apply(null, []);
    ...
    var runInContext = (function runInContext(context) {
      context = context == null ? global : _.defaults(root.Object(), context, _.pick(root, contextProps));
      ...
      var ctxClearTimeout = context.clearTimeout !== root.clearTimeout && context.clearTimeout,
          ctxNow = Date && Date.now !== global.Date.now && Date.now,
          ctxSetTimeout = context.setTimeout !== global.setTimeout && context.setTimeout;
      ...
      var setTimeout = ctxSetTimeout || function(func, wait) {
        return global.setTimeout(func, wait);
      };
